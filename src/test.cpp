...
TEST(constructor_test, copy_constructor) {
    sfleta_Matrix Matrix1(3, 3);
    Matrix1.setElem(0, 2 , 3.14);
    sfleta_Matrix Matrix2(Matrix1);
...
TEST(constructor_test, move_constructor) {
    ...
    sfleta_Matrix Matrix2(std::move(Matrix1));

    sfleta_Matrix Matrix3(3, 3);
...
TEST(sum_test, test1) {
    ...
    vector<double> result_v{5, 34, 6,
                            8, 3, 12.3,
                            14, 16, 10.03};
    sfleta_Matrix result_matrix(3, 3);
...
TEST(transpose_test, test1) {
    ...
    sfleta_Matrix Matrix2 = Matrix1.transpose();
...
TEST(setCols_test, test1) {
    ...
    sfleta_Matrix Result_matrix(3, 4);
    Result_matrix.fill_matrix_from_vector(vec2);
...
TEST(setRows_test, test1) {
    ...
    vector<double> vec2 = {12.345, -0.42,  56.1,
                            ...
                            72.99,  0.56,   -81.1,
                            0,        0,   3.14};
    sfleta_Matrix Result_matrix(4, 3);
    Result_matrix.fill_matrix_from_vector(vec2);
...
TEST(test_operator_mul, test1) {
    ...
    sfleta_Matrix Result_matrix(Matrix1);
...
TEST(test_operator_sub, test2) {
    ...
    sfleta_Matrix Matrix2(3, 3);
    Matrix2.fill_matrix_from_vector(vec2);
    sfleta_Matrix Matrix3(Matrix2);
    Matrix3 -= Matrix1;
    ASSERT_TRUE(Matrix3 == Matrix1);
}

TEST(test_throw, test1) {
    ASSERT_ANY_THROW(sfleta_Matrix Matrix1(-2, 1));
}

TEST(test_throw, test2) {
    ASSERT_ANY_THROW(sfleta_Matrix Matrix1(5, -4));
}

TEST(test_throw, test3) {
    ASSERT_ANY_THROW(sfleta_Matrix Matrix1(-2, -2));
}

TEST(test_throw, test4) {
    sfleta_Matrix Matrix1(10, 14);
    ASSERT_ANY_THROW(Matrix1.setCols(-1));
    ASSERT_ANY_THROW(Matrix1.setRows(-13));
}

TEST(test_throw, test5) {
    sfleta_Matrix Matrix1(5, 3);
    sfleta_Matrix Matrix2(3, 5);
    ASSERT_ANY_THROW(Matrix1 + Matrix2);
}

TEST(test_throw, test6) {
    sfleta_Matrix Matrix1(1, 1);
    sfleta_Matrix Matrix2(2, 2);
    ASSERT_ANY_THROW(Matrix1 + Matrix2);
}

TEST(test_throw, test7) {
    sfleta_Matrix Matrix1(21, 11);
    sfleta_Matrix Matrix2(21, 21);
    ASSERT_ANY_THROW(Matrix1 + Matrix2);
}
